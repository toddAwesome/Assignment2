...
function Background(game) {
	...
	this.Animation = new Animation(ASSET_MANAGER.getAsset("./img/dodgeball.png"), 0, 0, 600, 330, 1, 1, true, false);
	this.bounds = [ {x1:26, y1:26, x2:548, y2:276}, ]; 
...
function Rock(game) {
 //   this.player = 1;
    ...
    this.maxSpeed = 200;
    this.thrown = false;
	Entity.call(this, game, rockPositionX, rockPositionY);
...
function Blue(game) {
    ...
    this.color = "Blue";
    this.cooldown = 0;
    Entity.call(this, game, bluePositionX, bluePositionY);
	this.velocity = { x: 0, y: 0 };
};
...
function Red(game) {
    ...
    this.color = "Red";
    this.cooldown = 0;
    Entity.call(this, game, redPositionX, redPositionY);
	this.velocity = { x: 0, y: 0 };
};
...
ASSET_MANAGER.queueDownload("./img/dodgeball.png");
